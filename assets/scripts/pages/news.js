    ...
    return {
        markup: renderPageLayout({
            ...
            hero: {
                ...
                lead: "В карточках уже есть первые пять новостей с фото, датами и короткими итогами, чтобы раздел был готов к показу заказчику.",
                actions: [
                ...
                note: {
                    ...
                    items: [
                        "Фото и визуальные акценты",
                        "Краткое содержание без перегруза",
                        "Понимание, что приют реально работает"
                    ]
                }
            },
            content
